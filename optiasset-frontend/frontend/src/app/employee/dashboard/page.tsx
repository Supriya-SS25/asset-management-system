...
export default function EmployeeDashboardPage() {
  ...
  const getCategoryImage = (category: string) => {
    switch (category.toLowerCase()) {
        case "laptop": return "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&q=80&w=800";
        case "phone": case "mobile": return "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&q=80&w=800";
        case "monitor": return "https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&q=80&w=800";
        case "headphones": case "headphone": case "audio": return "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&q=80&w=800";
        case "tablet": case "tab": return "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&q=80&w=800";
              ...
              {assets.map(asset => (
                <div key={asset.id} className="relative group rounded-md bg-[#232323] overflow-hidden card-hover border border-white/5 flex flex-col">
                   <div className="aspect-video w-full overflow-hidden relative">
                     <img src={getCategoryImage(asset.category)} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
